...
export const EarningsFilter: React.FC<EarningsFilterProps> = ({
    ...
    const onChangeDate = (event: any, selectedDate?: Date) => {
        ...
        if (selectedDate) {
            if (showPicker === 'start') {
                const newEnd = endDate && selectedDate > endDate ? selectedDate : endDate;
                onRangeChange('custom', selectedDate, newEnd);
            } else {
                const newStart = startDate && selectedDate < startDate ? selectedDate : startDate;
            ...
            <View style={styles.tabContainer}>
                {(['weekly', 'monthly', 'custom'] as const).map((range) => {
                    ...
                    return (
                        <TouchableOpacity
                            key={range}
                            onPress={() => range === 'custom' ? onRangeChange('custom', startDate, endDate) : handlePresetChange(range)}
