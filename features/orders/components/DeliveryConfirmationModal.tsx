    ...
    const handleConfirm = () => {
        if (method === 'OTP') {
            ...
            if (image) {
                ...
                const mockImage = 'https://via.placeholder.com/300x400.png?text=Proof+of+Delivery';
                setImage(mockImage);
            }
        }
    };
                            ...
                            <View style={styles.actions}>
                                ...
                                <TouchableOpacity
                                    style={[
                                        ...
                                        ((method === 'OTP' && otp.length !== 4) || (method === 'PHOTO' && !image && method === 'PHOTO')) && styles.disabledButton
                                    ]}
