                        ...
                        <View style={styles.content}>
                            ...
                            {isLoadingRiders ? (
                                ...
                                <View style={{ marginVertical: 40, alignItems: 'center' }}>
                                    <Text style={{ color: '#EF4444', marginBottom: 8 }}>Failed to load riders</Text>
                                    <Text style={{ fontSize: 12, color: '#64748B' }}>Please try again later</Text>
                                </View>
                            ) : (
                                <FlatList
                                    data={riders}
                                    ...
                                    renderItem={({ item }) => (
                                        ...
                                        >
                                            <View>
                                                <Text style={styles.riderName}>{getDisplayName(item)}</Text>
